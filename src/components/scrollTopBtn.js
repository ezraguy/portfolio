...
class ScrollTopBtn extends Component {
    ...
    render() {
        ...
        return (<button id="topBtn" disabled={dis} style={{ visibility: visibility, opacity: opacity }} onClick={() => this.scrollUp()} className="topBtn"><img alt="arrow" src={require('../images/arrow-up.svg')}></img></button>);
    }
}
